...
var _bnpApi = require("./bnpApi");

var _bnpApi2 = _interopRequireDefault(_bnpApi);

angular.module("dimBungieNetPlatform", []);

angular.module("dimBungieNetPlatform").constant("dimBungieNetPlatform.config", config);

var config = (0, _bnpApi2["default"])();


},{"./bnpApi":1}],3:[function(require,module,exports){
(function (global){
"use strict";
...
var post = [{
  ...
  return _lodash2["default"].extend(obj, {
    "options": {
      "method": "POST",
      "headers": {
